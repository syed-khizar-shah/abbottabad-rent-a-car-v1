...
export default function EditReviewPage() {
  ...
  const loadReview = async () => {
    try {
      const reviewData = await reviewsApi.getOne(reviewId)
      ...
      setFormData({
        ...
        vehicle: reviewData.vehicle || "",
        review: reviewData.review || "",
        helpful: reviewData.helpful?.toString() || "0",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await reviewsApi.update(reviewId, formDataToSend)
      router.push("/admin/reviews")
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 sm:px-6 py-8 max-w-2xl">
        ...
        <Card className="p-6">
          <h1 className="text-3xl font-bold font-serif mb-6">Edit Review</h1>
              ...
              <div className="space-y-2">
                {(imagePreview || review?.image) && (
                  <div className="relative w-full h-48 border rounded-lg overflow-hidden">
                    <Image
                      src={imagePreview || review?.image || "/placeholder.svg"}
                      alt="Review preview"
                      fill
