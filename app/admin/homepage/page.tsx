        ...
        <div className="container mx-auto px-4 py-8">
          <Card className="p-6 text-center">
            <p className="text-muted-foreground mb-4">
              No homepage content found. Please run the seed script first.
            </p>
              ...
              <div className="space-y-3 sm:space-y-4 mb-3 sm:mb-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField("offersSectionTitle", e.target.value)
                    }
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateField("offersSectionSubtitle", e.target.value)
                    }
                    className="w-full px-3 py-2 border rounded-lg"
                    rows={2}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField("offersSectionBadge", e.target.value)
                    }
                    className="w-full px-3 py-2 border rounded-lg"
                  />
                </div>
              ...
              <div className="space-y-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField("brandsSectionTitle", e.target.value)
                    }
                    className="w-full px-3 py-2 border rounded-lg"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField("brandsSectionSubtitle", e.target.value)
                    }
                    className="w-full px-3 py-2 border rounded-lg"
                  />
                </div>
              ...
              <div className="space-y-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField("benefitsSectionTitle", e.target.value)
                    }
                    className="w-full px-3 py-2 border rounded-lg"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateField("benefitsSectionSubtitle", e.target.value)
                    }
                    className="w-full px-3 py-2 border rounded-lg"
                    rows={2}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField("benefitsSectionBadge", e.target.value)
                    }
                    className="w-full px-3 py-2 border rounded-lg"
                  />
                </div>
              ...
              <div className="space-y-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField("faqSectionTitle", e.target.value)
                    }
                    className="w-full px-3 py-2 border rounded-lg"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      updateField("faqSectionSubtitle", e.target.value)
                    }
                    className="w-full px-3 py-2 border rounded-lg"
                    rows={2}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField("faqSectionBadge", e.target.value)
                    }
                    className="w-full px-3 py-2 border rounded-lg"
                  />
                </div>
