    ...
    <div className="flex flex-col">
      ...
      <section ref={heroRef} className="relative py-24 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src={content.heroImage || "/professional-luxury-car-rental-service-team.jpg"}
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <AnimatedSection direction="left">
              <div className="space-y-6">
                <h2 className="text-3xl md:text-4xl font-serif font-bold">{content.storyTitle}</h2>
                <div className="space-y-4 text-muted-foreground text-sm md:text-base leading-relaxed">
                  {content.storyParagraphs && content.storyParagraphs.map((paragraph: string, index: number) => (
            ...
            <AnimatedSection direction="right">
              <div className="relative h-[400px] md:h-[500px] rounded-lg overflow-hidden shadow-2xl">
                <motion.div whileHover={{ scale: 1.05 }} transition={{ duration: 0.7 }} className="w-full h-full">
                  <Image
                    src={content.storyImage || "/luxury-car-showroom-elegant-interior.jpg"}
                    alt="Luxury showroom"
                    fill
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-muted/30 via-background to-muted/50">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-4">{content.valuesTitle}</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {content.values && content.values.map((value: any, index: number) => {
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-4">{content.timelineTitle}</h2>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-6 md:space-y-8">
              {content.milestones && content.milestones.map((milestone: any, index: number) => (
                <AnimatedSection key={index} delay={index * 0.15} direction="left">
                  <div className="flex gap-4 md:gap-6 items-start group">
                    <div className="flex flex-col items-center">
                      ...
                      {index < (content.milestones?.length || 0) - 1 && <div className="w-0.5 h-full bg-border mt-4 min-h-[60px]" />}
                    </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-muted/50 via-background to-muted/30">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-4">{content.teamTitle}</h2>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <AnimatedSection className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold mb-4">{content.certificationsTitle}</h2>
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 max-w-4xl mx-auto">
            {content.certifications && content.certifications.map((cert: string, index: number) => (
