        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10 md:gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-muted-foreground text-sm md:text-base max-w-md leading-relaxed">
              Experience the pinnacle of luxury automotive rentals in Abbottabad. Your journey to extraordinary begins
              here.
            </p>
          ...
          <div className="space-y-5">
            <h3 className="font-serif font-bold text-base md:text-lg mb-6 text-foreground">Company</h3>
          ...
          {/* Services Links */}
          <div className="space-y-5">
            <h3 className="font-serif font-bold text-base md:text-lg mb-6 text-foreground">Services</h3>
            <ul className="space-y-3.5">
          ...
          {/* Support Links */}
          <div className="space-y-5">
            <h3 className="font-serif font-bold text-base md:text-lg mb-6 text-foreground">Support</h3>
            <ul className="space-y-3.5">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-6 md:py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-muted-foreground">
            <p className="text-center md:text-left">
              &copy; {new Date().getFullYear()} Abbottabad Rent a Car. All rights reserved.
            </p>
